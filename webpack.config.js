		...
		rules: [
			...
			},
			{
				...
				generator: {
					filename:
						mode === "development"
							? "assets/images/pictures/[name][ext]"
							: "assets/images/pictures/[contenthash][ext]"
				}
			},
			{
				test: /\.(svg)$/i,
				...
				generator: {
					filename:
						mode === "development"
							? "assets/images/svg/[name][ext]"
							: "assets/images/svg/[contenthash][ext]"
				}
			},
			{
			...
			},
			{
				...
				generator: {
					filename:
						mode === "development"
							? "assets/sounds/[name][ext]"
							: "assets/sounds/[contenthash][ext]"
				}
			}
		]
	},
